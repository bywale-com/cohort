...
const client = new Proxy({}, {
    get (target, prop) {
        ...
        if (!actualClient) {
            throw new Error('Missing NEXT_PUBLIC_SANITY_PROJECT_ID. Please add it to your .env.local file. ' + 'Get your project ID from https://sanity.io/manage or by running: npx sanity init');
        }
